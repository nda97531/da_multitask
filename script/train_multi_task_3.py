...
def load_data(folder: str):
    ...
    train_dict_3 = {key: np.concatenate(value) for key, value in train_dict_3.items()}
    ...
    train_set_3 = ResampleArrayDataset(train_dict_3)
    valid_set = BasicArrayDataset(valid_dict)

    return [train_set_1, train_set_2, train_set_3], valid_set
...
if __name__ == '__main__':
    ...
    train_log, valid_log = flow.run(
        ...
        valid_loader=[valid_loader, None, None],  # only valid the first task
