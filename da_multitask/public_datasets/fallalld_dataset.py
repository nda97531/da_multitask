...
from da_multitask.public_datasets.constant import G_TO_MS2, DEG_TO_RAD
from da_multitask.utils.number_array import interp_resample
...
if __name__ == '__main__':
    parquet_dir = '/mnt/data_drive/projects/processed_parquet/FallAllD/'
